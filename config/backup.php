...
return [
    ...
    'notifications' => [
        ...
        'discord' => [
            'webhook_url' => env('DISCORD_WEBHOOK_POST'),

            'username' => 'chengkangzai.com Backup BOT',

            'avatar_url' => 'https://www.chengkangzai.com/android-chrome-512x512.png',
        ],
    ],
    ...
    'monitor_backups' => [
        [
            ...
            'health_checks' => [
                ...
                \Spatie\Backup\Tasks\Monitor\HealthChecks\MaximumStorageInMegabytes::class => 4000,
            ],
        ],

    ...
    <div class="mb-2">
        ...
        <div class="sm:grid sm:grid-cols-2 sm:mt-2 gap-2 space-y-2 sm:space-y-0">
            <div class="bg-gray-50 rounded-xl shadow p-4">
                <livewire:covid-dashboard.graph.case-per-day :date="$date" :confirmCase="$confirmCase"
                    :recoveredCase="$recoveredCase" />
            </div>

            <div class="bg-gray-50 rounded-xl shadow p-4">
                <livewire:covid-dashboard.graph.death-per-day :date="$date" :deathCase="$deathCase" :bidCase="$bidCase"
                    :dodCase="$dodCase" />
            </div>

            <div class="bg-gray-50 rounded-xl shadow p-4">
                <livewire:covid-dashboard.graph.active-case-vs-health-care :date="$date" :activeCase="$activeCase"
                    :cat1="$cat1" :cat2="$cat2" :cat3="$cat3" :cat4="$cat4" :cat5="$cat5" />
            </div>

            <div class="bg-gray-50 rounded-xl shadow p-4">
                <livewire:covid-dashboard.graph.active-case-percentage :date="$date" :activeCase="$activeCase"

<div class="block w-full h-full bg-white space-y-4 mb-10 mt-5">
    <h2 class="text-2xl px-5 font-bold"> {{__('Create User')}}</h2>
        ...
        <div class="space-y-4 mt-4">
            ...
            <div>
                <label class="text-gray-700">{{__('Confirm Password')}}
                    <x-input type="password" name="password_confirmation" wire:model.debounce="password_confirmation"
            ...
            <div>
                <label class="text-gray-700" for="role">{{__('Role')}}
                    <select class="form-input w-full mt-2 rounded-md focus:border-indigo-600 text-black"
                        ...
                        @foreach($rolesSelect->reverse() as $role)

        ...
        <div class="p-6 max-w-sm w-full bg-white shadow-md rounded-md">
            ...
            @if (session('status'))
                <div class="mb-2 w-full mx-auto">
                    <div
                        class="block text-sm text-left text-black font-bold bg-violet-200 border border-violet-400 h-auto flex items-center p-4 rounded-lg"
                        role="alert">
                        {{ session('status') }}
                    </div>
                </div>
                    ...
                    <div>
                        <label class="inline-flex items-center">
                            <input type="checkbox" name="remember"
                                   {{ old('remember') ? 'checked' : '' }} class="form-checkbox text-indigo-600 rounded"/>

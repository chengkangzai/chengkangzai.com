                    ...
                    <div class="w-full mb-10 ">
                        ...
                        <div class="space-x-4 space-y-2">
                            ...
                            <p class="text-white text-gray-600 dark:text-gray-200">
                                ...
                                <a class="text-lg underline" rel="noreferrer" target="_blank" aria-label="My Linkedin Profile"
                            ...
                            <p class="text-white text-gray-600 dark:text-gray-200">
                                ...
                                <a class="text-lg underline" rel="noreferrer" target="_blank" aria-label="My Twitter Account"
                ...
                <div class="md:w-1/3 sm:w-full bg-white dark:bg-black flex items-center justify-center px-5 py-8  "
                    ...
                    <div
                        ...
                        <div class="w-full mb-10 mt-5">
                            <div class="w-full">
                                <a href="{{$work->url ?? "#"}}" target="_blank" rel="noreferrer" aria-label="Link to open {{$work->name}}">
                            ...
                            <div
                                ...
                                @if($work->url)
                                    <a rel="noopener" target="_blank" href="{{$work->url ?? "#"}}" aria-label="Link to open {{$work->name}}">
                                ...
                                @endif
                                @if($work->github_url)
                                    <a href="{{$work->github_url}}" rel="noopener" target="_blank" aria-label="Link to open Project Repository">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40"
                                             viewBox="0 0 24 24"

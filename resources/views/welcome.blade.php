    ...
    <div class="md:w-11/12 mx-auto ">
        ...
        <section id="about-me">
            ...
            <div class="flex flex-wrap w-full mx-auto pb-8">
                ...
                <div
                    class="md:w-1/3 w-full flex items-center justify-center px-5 py-8 transform hover:scale-110 transition duration-300">
                    <div class="w-full mx-auto rounded-lg bg-gray-50 dark:bg-gray-800 shadow-lg text-gray-800 py-8">
                        <div class="w-full mb-10 ">
        ...
        <section class="md:py-32 hidden md:block" id="experience">
            <div id="roadmap"
                ...
                <a href="#experience"
                   class="mb-2 text-2xl font-black text-black block text-center dark:text-white lg:text-3xl md:text-2xl py-12">
                    {{ __('My Experiences') }}</a>
                <hr>
                <div class="relative wrap overflow-hidden p-10 h-full">
                    ...
                    <div class="mb-8 flex justify-between items-center w-full right-timeline ">
                        ...
                        <div
                            ...
                            <h3 class="mb-3 font-bold text-white text-xl">{{ __('Internship at') }}
                                <a class="underline" href="https://www.mysoftinn.com/" rel="noreferrer"
                                   target="_blank">
                                    Softinn Solutions
                                </a>
                            </h3>
                    ...
                    <div class="mb-8 flex justify-between flex-row-reverse items-center w-full left-timeline">
                        ...
                        <div
                            class="z-20 flex items-center order-1 bg-gray-800  dark:bg-gray-100 shadow-xl w-8 h-8 rounded-full transform hover:scale-125 transition duration-300">
                            <p class="mx-auto font-semibold text-lg text-white dark:text-black">8</p>
                        </div>
                        <div
                            class="order-1 bg-blue-600 rounded-lg shadow-xl w-5/12 px-6 py-4 transform hover:scale-110 transition duration-300">
                            <h3 class="mb-3 font-bold text-white text-xl">{{ __('Graduated from') }}

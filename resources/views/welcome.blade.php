    ...
    <div class="md:w-11/12 mx-auto ">
            ...
            <div
                ...
                <div
                    ...
                    <div class="w-full mb-10 text-center">
                        ...
                        <br>
                        <p class="text-white text-gray-600 dark:text-gray-200 px-5">
                            My knowledge in this field are currently self-experience & academically, so they might look fundamental and
            ...
            <div
                ...
                <div
                    ...
                    <div class="w-full mb-10 ">
                        ...
                        <p class="text-white text-gray-600 dark:text-gray-200 px-5 py-2">
                            ...
                            <a class="text-lg underline" rel="noreferrer" target="_blank"
                               href="https://www.github.com/chengkangzai">github.com/chengkangzai</a>
                        </p>
                        <p class="text-white text-gray-600 dark:text-gray-200 px-5 py-2">
                            <svg class="h-6 w-6 fill-current text-blue-600 inline" viewBox="0 0 512 512">
                                <path
                            ...
                            <a class="text-lg underline" rel="noreferrer" target="_blank"
                               href="https://www.linkedin.com/in/chingchengkang/">linkedin.com/in/chingchengkang/</a>
                        </p>
                        <p class="text-white text-gray-600 dark:text-gray-200 px-5 py-2">
        ...
        <section class="md:py-32 hidden md:block">
            <div class="container rounded-lg bg-gray-50 dark:bg-gray-800 mx-auto w-full h-full min-h-full flex-wrap "
                 id="roadmap">
                <h1 class="mb-2 text-2xl font-black text-black text-center dark:text-white lg:text-3xl md:text-2xl py-12"
                    id="experience">
                    The Experience</h1>
                <hr>

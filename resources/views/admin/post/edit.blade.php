    ...
    <div class="mt-8">
        <div class="mt-4">
            ...
            <div class="rounded-md bg-white p-6 shadow-md">
                <h2 class="text-lg font-semibold capitalize text-gray-700">{{ __('Edit') }} {{ $post->title }}</h2>
                        ...
                        <div class="col-span-2">
                            <label class="text-gray-700">{{ __('Content') }}
                                <textarea name="content" id="editor"
                                    class="focus:shadow-outline w-full rounded border border-gray-400 px-3 py-2 text-gray-800 placeholder-gray-400 focus:border-transparent focus:outline-none">{!! old('content', $post->content) !!}</textarea>
                            </label>
                        </div>
                    </div>

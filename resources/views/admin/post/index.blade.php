                ...
                <tr class="bg-gray-100 dark:bg-gray-800 text-center border-b text-base text-gray-600 dark:text-gray-400">
                    ...
                    <td class="p-2 border-r space-y-2">
                        <a href="{{route('admin.posts.show',$post)}}"
                           class="bg-green-500 hover:bg-green-700 p-2 text-white hover:shadow-lg font-bold rounded">
                            {{__('Show')}}</a>
                        <a href="{{route('admin.posts.edit',$post)}}"
                           class="bg-blue-500 hover:bg-blue-700 p-2 text-white hover:shadow-lg font-bold rounded">
                            {{__('Edit')}}</a>

                    ...
                    <div class="mt-4 space-y-4">
                        ...
                        <div class="md:w-1/2">
                            ...
                            <select id="permissions" name="permissions[]"
                                class="focus:shadow-outline w-full rounded border border-gray-400 bg-white px-3 py-2 text-gray-800 placeholder-gray-400 focus:border-transparent focus:outline-none">

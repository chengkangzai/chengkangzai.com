...
@section('footer')
    <!-- footer -->
    <footer class="bg-white dark:bg-gray-900 w-full py-6 px-4 border-t-2 "><!-- marging just for display-->
        <div class="flex items-center justify-between my-4">
            <p class="text-blue-500 px-2 pt-6">All rights reserved</p>
            <p class="text-blue-500 px-2 pt-6">Built with ❤️ by Ching Cheng Kang.</p>
            <div class="flex items-center px-2 pt-6">
                <a href="https://www.facebook.com/kangkang.pitiful">
                ...
                <a href="https://www.twitter.com/chengkangzai">
                    <svg class="h-6 w-6 fill-current text-blue-600 mr-6" viewBox="0 0 512 512">
                        <path

    ...
    <div x-data="LivewireUIModal()" x-init="init()" x-on:close.stop="show = false"
        ...
        <div
            ...
            <div x-show="show" x-on:click="closeModalOnClickAway()" x-transition:enter="ease-out duration-300"
                ...
                x-transition:leave-end="opacity-0" class="fixed inset-0 transition-all">
            ...
            <div x-show="show && showActiveComponent" x-transition:enter="ease-out duration-300"
                ...
                class="inline-block w-full overflow-hidden rounded-lg bg-white text-left align-bottom shadow-xl transition-all sm:my-8 sm:w-full sm:align-middle">

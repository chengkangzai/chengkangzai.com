...
<div class="w-64 max-h-screen bg-white dark:bg-gray-800 " >
    ...
    <nav class="mt-10">
        <div x-data="{ open: true }">
            <button @click="open = !open" class="w-full flex justify-between items-center py-3 px-6 text-gray-600 dark:text-gray-100 cursor-pointer hover:bg-gray-100 hover:text-gray-700 focus:outline-none">
...
{{--        </div>--}}
    ...
    <div class="absolute bottom-0 my-8">
        <a class="flex items-center py-2 px-8 text-gray-700 dark:text-gray-200 hover:text-gray-600 dark:hover:text-gray-100" href="#">
